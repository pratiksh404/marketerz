            ...
            <div class="card-body">
                <div class="tabbed-card">
                    <ul class="pull-right nav nav-pills nav-primary" id="pills-clrtab1" role="tablist">
                        <li class="nav-item"><a class="nav-link active" id="pills-clrproject-tab1" data-bs-toggle="pill"
                                href="#pills-clrproject1" role="tab" aria-controls="pills-clrproject1"
                                aria-selected="true" data-bs-original-title="" title="">Week</a></li>
                    ...
                    <div class="tab-content" id="pills-clrtabContent1">
                        <div class="tab-pane fade show active" id="pills-clrproject1" role="tabpanel"
                            aria-labelledby="pills-clrproject-tab1">
